...
const eventsEmitter = server.listen(3000, "0.0.0.0");
const {env: {DEFAULT_FILE_NAME = '/index.html', env = 'development', DEFAULT_MIME_TYPES = {}, DIST_FOLDER = `../js-lessons-feature-simple-http-server/dist`}} = process;
